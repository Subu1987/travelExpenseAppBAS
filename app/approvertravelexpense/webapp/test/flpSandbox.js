		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Approver Travel &amp; Expense Application",
									"targetURL": "#sembcorpcomapprovertravelexpense-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sembcorpcomapprovertravelexpense-display": {
								"semanticObject": "sembcorpcomapprovertravelexpense",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sembcorp.com.approvertravelexpense",
									"url": sap.ui.require.toUrl("sembcorp/com/approvertravelexpense")
								}
							}
						}
					}
